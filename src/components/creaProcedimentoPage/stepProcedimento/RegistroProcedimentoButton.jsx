                ...
                startAdornment: (
                    <InputAdornment position="start" sx={{alignItems: 'center', justifyContent: 'center', position: 'absolute', left:'0', flex:'1', marginRight: '0', fontFamily: 'Roboto', fontWeight: '500'}}>
                        <div style={{display: 'flex', flexDirection: 'row', flex: `1`, minWidth: minWidth, height: '34.13px', color: theme.palette.text.primary}}>
                            <input onChange={() => onChange(getNumProtocolloValidate(numProtocolloRef), annoRef.current.value )} ref={numProtocolloRef} maxLength="6" defaultValue={numProtocollo ? numProtocollo : ''} type="text" style={{width: '60%', minWidth: '55px',  border: 'none', paddingRight: '2.5px', textAlign: 'right', outline: 'none', fontFamily: 'Roboto', fontWeight: '500', fontSize: '1rem', color: theme.palette.text.primary}} />
                            <div style={{display:'flex', justifyContent: 'center', alignItems:'center', padding: '0 2px', fontSize: '1.4rem', color: '#cdcdcd'}}>/</div>
                            <input onChange={() => onChange(numProtocolloRef.current.value, getAnnoValidate(annoRef) )} ref={annoRef} defaultValue={anno ? anno : new Date().getFullYear()} type="text" maxLength="4" style={{width: '23%', maxWidth: '65px', border: 'none', paddingLeft: '2.5px', outline: 'none', fontFamily: 'Roboto', fontWeight: '500', fontSize: '1rem', color: theme.palette.text.primary}}/>
                        </div>
                    </InputAdornment>
                ),
            }}
